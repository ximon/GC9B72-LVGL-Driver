...
//set #define LV_USE_SYSMON 0 to turn off fps monitor 
...
#define LV_USE_GC9B72        1

#if (LV_USE_ST7735 | LV_USE_ST7789 | LV_USE_ST7796 | LV_USE_ILI9341 | LV_USE_NV3007 | LV_USE_GC9B72)
